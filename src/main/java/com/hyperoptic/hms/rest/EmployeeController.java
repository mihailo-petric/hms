...
public class EmployeeController {
  ...
  @GetMapping
  @Operation(summary = "Get all employees with pagination", description = "Retrieves a paginated list of all employees.")
  ...
  @GetMapping("/search")
  @Operation(summary = "Search employees by name, team, or team lead", description = "Searches for employees based on their name, team, or team lead.")
